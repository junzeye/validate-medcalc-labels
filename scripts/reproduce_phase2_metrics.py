"""
Reproduce Phase 2 Physician Validation Metrics (Table 3 in the ArXiv paper)
=========================================================
This script reproduces Table 3 from the paper, which reports the physician 
validation results from Phase 2 (§3.2.1). It compares the original MedCalc-Bench 
...
Data source:
    data/phase2/phase2_MDs_blind_eval/y_new_and_sampled_MD_evals.xlsx
